...
func printHelp(out io.Writer) {
	...
	fmt.Fprintln(out, "  just release plan <mode> <fest> <camp> <festival_installer>")
	fmt.Fprintln(out, "  just release dev <fest> <camp> <festival_installer>")
	fmt.Fprintln(out, "  just release rc <fest> <camp> <festival_installer>")
	fmt.Fprintln(out, "  just release stable <fest> <camp> <festival_installer>")
	fmt.Fprintln(out, "  selectors are positional (latest, keep, or vX.Y.Z); e.g. just release stable keep keep keep")
	fmt.Fprintln(out)

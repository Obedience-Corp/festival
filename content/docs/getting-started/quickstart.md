...
If you are not sure whether this work should start as an intent, a design doc, or a festival, read [Intent vs Design vs Festival]({{< ref "/docs/guides/intent-design-festival" >}}) before creating more planning artifacts.
